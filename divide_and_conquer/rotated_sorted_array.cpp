    ...
    namespace rotated_sorted_array
    {
        ...
        int FindX(const std::vector<int> &rotated_sorted_array, int x)
        {
            ...
            if (x >= rotated_sorted_array[0])
                return divide_and_conquer::binary_search::BinarySearch(rotated_sorted_array, x, 0, index_of_rotation);
            else
                return divide_and_conquer::binary_search::BinarySearch(rotated_sorted_array, x, index_of_rotation + 1, rotated_sorted_array.size() - 1);
        }
